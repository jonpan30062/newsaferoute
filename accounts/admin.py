...
class SafetyConcernAdmin(admin.ModelAdmin):
    ...
    date_hierarchy = 'created_at'
    readonly_fields = ['created_at', 'updated_at', 'photo_preview', 'status_change_section']
    ...
    fieldsets = (
        ("⚡ Quick Status Change", {
            ...
            "classes": ("wide",),
            "description": "Quickly change the status and add notes below"
        }),
        ("Status & Tracking", {
    ...
    actions = [
        "approve_concerns", "mark_as_in_review", "mark_as_resolved", 
        "mark_as_dismissed", "mark_as_pending"
    ]
